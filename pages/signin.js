...
export default function Signin() {
    ...
    return (
        ...
        <Layout title='Sign in'>
            <div className="grid gap-y-4 py-5 px-3.5 md:py-9 md:px-8 w-full max-w-sm mx-auto">
                <h1 className='text-3xl text-center font-medium font-logo mb-8 leading-none'>Indragram</h1>
                <div className='grid gap-y-3 rounded-lg border border-slate-300 bg-slate-100 p-3'>
                    ...
                    <h1 className='py-2 px-3 bg-blue-500 text-center text-slate-50 text-sm font-bold rounded-full cursor-pointer my-1'>Sign in</h1>
