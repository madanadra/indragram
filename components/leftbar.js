...
export default function Leftbar() {
    ...
    const Menu = ({title, icon}) => {
        return (
            <div className='rounded-full p-3 cursor-pointer hover:bg-slate-50 flex items-center gap-x-3.5 group'>
    ...
    return (
        <div className="py-9 px-3 hidden md:grid xl:w-[245px] h-screen content-between border-r border-slate-300 sticky top-0">
            ...
            <div className='grid gap-y-1.5'>
                ...
                className='h-full aspect-square rounded-full border border-slate-300 p-px' />} title='Profile' />
            </div>
